...
provenance: human
scope: [knowledgehub]
tags: [method, tools, environment, development, creative, content]
...
The tools below are what I actually use, in the environments I actually
work in. No aspirational stack.
...
Also comfortable on macOS and Windows.
